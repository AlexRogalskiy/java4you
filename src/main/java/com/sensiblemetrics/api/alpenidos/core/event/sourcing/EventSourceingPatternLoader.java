package com.sensiblemetrics.api.alpenidos.core.event.sourcing;
...
import com.sensiblemetrics.api.alpenidos.core.event.sourcing.processor.DomainEventProcessor;
