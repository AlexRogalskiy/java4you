package com.sensiblemetrics.api.alpenidos.core.spring_boot.aspect;
...
public class AroundGetContactsAspect {
    ...
    @Pointcut("execution(* com.sensiblemetrics.api.alpenidos.core.spring_boot.service.BankService.*(..))")
