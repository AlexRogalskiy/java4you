package com.sensiblemetrics.api.alpenidos.core.observer2;

import com.sensiblemetrics.api.alpenidos.core.observer2.observable.GWeather;
import com.sensiblemetrics.api.alpenidos.core.observer2.observable.Weather;
import com.sensiblemetrics.api.alpenidos.core.observer2.observer.GHobbits;
import com.sensiblemetrics.api.alpenidos.core.observer2.observer.GOrcs;
import com.sensiblemetrics.api.alpenidos.core.observer2.observer.Hobbits;
import com.sensiblemetrics.api.alpenidos.core.observer2.observer.Orcs;
