package com.sensiblemetrics.api.alpenidos.core.factory_kit;

import com.sensiblemetrics.api.alpenidos.core.factory_kit.enums.WeaponType;
import com.sensiblemetrics.api.alpenidos.core.factory_kit.iface.Builder;
import com.sensiblemetrics.api.alpenidos.core.factory_kit.iface.Weapon;
import com.sensiblemetrics.api.alpenidos.core.factory_kit.iface.WeaponFactory;
import com.sensiblemetrics.api.alpenidos.core.factory_kit.model.Axe;
import com.sensiblemetrics.api.alpenidos.core.factory_kit.model.Bow;
import com.sensiblemetrics.api.alpenidos.core.factory_kit.model.Spear;
import com.sensiblemetrics.api.alpenidos.core.factory_kit.model.Sword;
