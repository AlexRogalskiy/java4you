package com.sensiblemetrics.api.alpenidos.core.concurrency.active_object;
...
public abstract class ActiveObject<T> {
    ...
    public Callback<T> enqueue(final Callable<T> request) throws InterruptedException {
        Callback<T> callback = new Callback<>(request);
        this.queue.put(callback);
