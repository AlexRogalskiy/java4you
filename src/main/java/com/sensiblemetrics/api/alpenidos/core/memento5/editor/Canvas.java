package com.sensiblemetrics.api.alpenidos.core.memento5.editor;

import com.sensiblemetrics.api.alpenidos.core.memento5.command.ColorCommand;
import com.sensiblemetrics.api.alpenidos.core.memento5.command.MoveCommand;
...
class Canvas extends java.awt.Canvas {
    ...
    public void paint(Graphics graphics) {
        final BufferedImage buffer = new BufferedImage(this.getWidth(), this.getHeight(), BufferedImage.TYPE_INT_RGB);
        final Graphics2D ig2 = buffer.createGraphics();
