 ...
 * <p>
 * Most of the time, this is the preferred approach if you are not using an enum. If you know that you will always need an instance of this Singleton, the eager
 * approach is fine.
 * <p>
 * If the Singleton has to perform resource/time expensive stuff on instantiation during startup of an application (e.g. booting of app server),  consider using
 * a lazy Singleton instead.
 * <p>
...
public class ClassicEagerSingleton {
    ...
    /**
     * We eagerly create the object at class loading time. Note that the member is static and final. Only 1 copy of this can exist.
     */
