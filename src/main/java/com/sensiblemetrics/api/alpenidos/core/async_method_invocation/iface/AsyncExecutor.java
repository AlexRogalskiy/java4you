...
public interface AsyncExecutor {
     ...
     */
    <T> AsyncResult<T> startProcess(final Callable<T> task);
     ...
     * @return async result for the task
     */
    <T> AsyncResult<T> startProcess(final Callable<T> task, final AsyncCallback<T> callback);
     ...
     */
    <T> T endProcess(final AsyncResult<T> asyncResult) throws ExecutionException, InterruptedException;
}
