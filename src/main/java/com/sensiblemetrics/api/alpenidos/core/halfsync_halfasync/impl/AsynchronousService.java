package com.sensiblemetrics.api.alpenidos.core.halfsync_halfasync.impl;

import com.sensiblemetrics.api.alpenidos.core.halfsync_halfasync.iface.AsyncTask;
...
public class AsynchronousService {
     ...
     */
    public AsynchronousService(final BlockingQueue<Runnable> workQueue) {
    ...
    public <T> void execute(final AsyncTask<T> task) {
        ...
        this.service.submit(new FutureTask<T>(task) {
            @Override
            protected void done() {
                super.done();
                try {
