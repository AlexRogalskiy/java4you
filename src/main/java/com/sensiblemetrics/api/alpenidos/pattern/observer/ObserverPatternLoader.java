package com.sensiblemetrics.api.alpenidos.pattern.observer;

import com.sensiblemetrics.api.alpenidos.pattern.observer.iface.Observer;
import com.sensiblemetrics.api.alpenidos.pattern.observer.impl.ConcreteObserver;
import com.sensiblemetrics.api.alpenidos.pattern.observer.impl.ConcreteSubject;
import com.sensiblemetrics.api.alpenidos.pattern.observer.model.Event;
import com.sensiblemetrics.api.alpenidos.pattern.observer.model.Subject;
