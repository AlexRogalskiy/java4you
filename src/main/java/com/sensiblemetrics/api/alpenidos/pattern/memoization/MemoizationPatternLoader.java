package com.sensiblemetrics.api.alpenidos.pattern.memoization;
...
public class MemoizationPatternLoader {
    ...
    public static void main(final String[] args) {
        final MemoizationPatternLoader main = new MemoizationPatternLoader();
