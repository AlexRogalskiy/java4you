package com.sensiblemetrics.api.alpenidos.pattern.enterprise.message_channel;
 ...
 */
public class MessageChannelPatternLoader {

    private static final Logger LOGGER = LoggerFactory.getLogger(MessageChannelPatternLoader.class);
