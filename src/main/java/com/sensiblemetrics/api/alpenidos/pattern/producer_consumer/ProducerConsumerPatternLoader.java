package com.sensiblemetrics.api.alpenidos.pattern.producer_consumer;
 ...
 */
public class ProducerConsumerPatternLoader {
    ...
    public static void main(String[] args) {
        var producerConsumer = new ProducerConsumerPatternLoader();
        try {
