/**
 * <h2>Facade</h2>
 * Used to provide a more abstract and shared/unified interface to multiple lower-level interfaces/classes/subsystems; a facade provides a higher-level and
 * simpler interface for Clients to use. A good facade presents to the client the appropriate level of abstraction.
 *
 * <h2>Actors</h2>
 * <ul>
 ...
 * <p>
 */
package com.sensiblemetrics.api.alpenidos.pattern.facade4;
