/**
 * <h2>Adapter</h2>
 * Makes incompatible classes/interfaces work with each other, by converting one interface into the format expected by the Client.
 * <p>
 * Classes/interfaces that get adapted are called Adaptees - they typically 3rd party APIs or legacy code that cannot be changed. In the case of APIs, these
 * normally just supply the JAR and Javadoc.
 * <p>
 ...
 * <p>
 * The class that adapts between the Adaptee and the Target is called the Adapter. The Adapter extends from the Target and 'wraps' the Adaptee. The wrapping is
 * done by passing the Adaptee into the constructor of the Adapter.
 * <p>
 ...
 * <p>
 */
package com.sensiblemetrics.api.alpenidos.pattern.adapter8;
