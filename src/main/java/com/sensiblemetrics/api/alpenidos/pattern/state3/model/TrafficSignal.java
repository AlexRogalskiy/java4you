package com.sensiblemetrics.api.alpenidos.pattern.state3.model;

import com.sensiblemetrics.api.alpenidos.pattern.state3.iface.TrafficSignalContext;
import com.sensiblemetrics.api.alpenidos.pattern.state3.iface.TrafficSignalUserInterface;
import com.sensiblemetrics.api.alpenidos.pattern.state3.impl.TrafficSignalGreenState;
