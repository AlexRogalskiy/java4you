package com.sensiblemetrics.api.alpenidos.pattern.interpreter3.converter;

import com.sensiblemetrics.api.alpenidos.pattern.interpreter3.iface.Expression;
import com.sensiblemetrics.api.alpenidos.pattern.interpreter3.impl.NumberExpression;
import com.sensiblemetrics.api.alpenidos.pattern.interpreter3.impl.UnitExpression;

import java.util.*;

import static com.sensiblemetrics.api.alpenidos.pattern.interpreter3.constants.InterpreterConstants.NUMBERS;
import static com.sensiblemetrics.api.alpenidos.pattern.interpreter3.constants.InterpreterConstants.UNITS;
