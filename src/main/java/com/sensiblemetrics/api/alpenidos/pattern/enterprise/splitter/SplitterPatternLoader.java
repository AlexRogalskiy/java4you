package com.sensiblemetrics.api.alpenidos.pattern.enterprise.splitter;
...
public class SplitterPatternLoader {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        final ConfigurableApplicationContext context = SpringApplication.run(SplitterPatternLoader.class, args);
