package com.sensiblemetrics.api.alpenidos.pattern.ambassador;

import com.sensiblemetrics.api.alpenidos.pattern.ambassador.client.Client;
...
public class App {
    ...
    public static void main(String[] args) {
        final Client host1 = new Client();
        final Client host2 = new Client();
        host1.useService(12);
        host2.useService(73);
    }
}
