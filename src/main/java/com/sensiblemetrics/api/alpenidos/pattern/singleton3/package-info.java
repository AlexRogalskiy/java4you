 ...
 * <p>
 * You can also use a class with a private constructor and a synchronised accessor method that creates (only once) an instance of the object and returns it to
 * the Client; this is the classic way of using Singletons. The classic way can create Singletons <em>eagerly</em> or <em>lazily</em> - see the class JavaDoc
 * for the differences.
 * <p>
