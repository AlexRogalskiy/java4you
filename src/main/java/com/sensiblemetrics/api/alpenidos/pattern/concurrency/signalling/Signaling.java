package com.sensiblemetrics.api.alpenidos.pattern.concurrency.signalling;

import com.sensiblemetrics.api.alpenidos.pattern.concurrency.Semaphore;
...
public class Signaling {
    ...
    public static void main(String[] args) {
        ...
        final int orden = (int) (Math.random() * 100) % 2;
